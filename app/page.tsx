  ...
  return (
    <main className="page">
      <header className="hero">
        <div>
          <div className="eyebrow">ANIME STREAM</div>
          <h1>Regarde ton anime.</h1>
          <p>
            Recherche un titre et retrouve rapidement tes favoris.
          </p>
        </div>
      </header>
              ...
              results.map((item) => (
                ...
                >
                  <div className="search-cover">
                    <img
                      src={item.image || `/api/image?slug=${item.slug}`}
                      alt=""
                      loading="lazy"
                    />
                  </div>
      ...
      <section className="featured-card">
        ...
        <div className="featured-content">
          ...
          <p>
            Recherche un titre pour accéder à ses saisons et épisodes.
          </p>
      ...
      <section className="section">
        <div className="section-header">
          ...
          {mounted && favorites.length > 0 && (
            <Link href="/favorites" className="see-all">
              Tout voir
            </Link>
          )}
        </div>
        ...
        {!mounted ? (
          ...
          <div className="empty-card">
            ...
            <h3>Aucun favori</h3>
            <p>
              Recherche un anime puis ajoute-le à ta bibliothèque.
            </p>
          </div>
        ) : (
